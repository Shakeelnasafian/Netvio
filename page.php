...
<main class="max-w-4xl mx-auto px-4 py-16">
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
            ...
            <?php
            $header_content = get_post_meta(get_the_ID(), '_netvio_header_content', true);
            $shortcode = get_post_meta(get_the_ID(), '_netvio_shortcode', true);

            if (!empty($header_content) && !empty($shortcode)) : ?>
